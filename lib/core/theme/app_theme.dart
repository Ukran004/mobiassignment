import 'package:career_connect/app/constants/theme_constant.dart';
  ...
  static getApplicationTheme({required bool isDarkMode}) {
    return ThemeData(
      ...
      appBarTheme: const AppBarTheme(
        elevation: 0,
        backgroundColor:
            Color.fromARGB(255, 0, 37, 79), // Updated top navigation bar color
        centerTitle: true,
      ...
      bottomNavigationBarTheme: const BottomNavigationBarThemeData(
        ...
        selectedItemColor: Color.fromARGB(255, 27, 116, 3),
